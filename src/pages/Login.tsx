...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-black bg-opacity-90 bg-[url('https://images.unsplash.com/photo-1531297484001-80022131f5a1')] bg-blend-overlay bg-cover bg-center flex items-center justify-center px-4">
